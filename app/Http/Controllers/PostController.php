...
class PostController extends Controller
{
    ...
    public function addPost(Request $request){
        ...
        if($request->has('post_image')){
            ...
            $url =url('/').'/posts/'. $file->getClientOriginalName();
    ...
    public function view($post_id){
            ...
            return view('posts.view',['posts' => $posts, 'categories' => $categories,'likeCtr' => $likeCtr,'dislikeCtr' => $dislikeCtr, 'comments' => $comment]);
     }
     ...
     public function edit($post_id){
      ...
      public function editPost(Request $request127,$post_id){
                $this->validate($request,[
            'post_title' => 'required',
            'post_body' => 'required',
            'category_id' => 'required',
