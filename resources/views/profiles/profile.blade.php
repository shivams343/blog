                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/addProfile') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="designation" type="input" class="form-control @error('desigation') is-invalid @enderror" name="designation" required autocomplete="current-designation">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="profile_pic" type="file" class="form-control @error('desigation') is-invalid @enderror" name="profile_pic" required autocomplete="current-profile_pic">
