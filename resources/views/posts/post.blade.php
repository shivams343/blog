                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="post_body" rows="7"  class="form-control @error('post_body') is-invalid @enderror" name="post_body" value="{{ old('post_body') }}" required autocomplete="post_body"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="post_image" type="file" class="form-control @error('desigation') is-invalid @enderror" name="post_image" required autocomplete="current-post_image">
