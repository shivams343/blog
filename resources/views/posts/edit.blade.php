                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="post_body" rows="7"  class="form-control @error('post_body') is-invalid @enderror" name="post_body"  required autocomplete="post_body">{{ $posts->post_body }}</textarea>
